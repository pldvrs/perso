...
(function () {
  ...
  var EMAIL = 'pierrelouis.divaris@outlook.com';
  ...
  function setLang(lang, persist) {
    ...
    var courseLink = document.querySelector('[data-mailto-course]');
    if (courseLink) {
      courseLink.href = 'mailto:' + EMAIL + '?subject=' + encodeURIComponent(meta.courseSubject);
    }
